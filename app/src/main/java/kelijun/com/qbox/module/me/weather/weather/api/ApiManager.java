package kelijun.com.qbox.module.me.weather.weather.api;
...
import kelijun.com.qbox.module.me.weather.weather.api.entity.DailyForecast;
import kelijun.com.qbox.module.me.weather.weather.api.entity.HourlyForecast;
import kelijun.com.qbox.module.me.weather.weather.api.entity.Weather;
import kelijun.com.qbox.utils.SPUtils;
import kelijun.com.qbox.module.me.weather.dynamicweather.BaseDrawer.Type;
...
public class ApiManager {
    ...
    public interface GeocoderListener {
        void onConvertCity(String cityName);
    ...
    public static String prettyDate(String date) {
        try {
            ...
            @SuppressLint("WrongConstant") int curYear = c.get(Calendar.YEAR);
            @SuppressLint("WrongConstant") int curMonth = c.get(Calendar.MONTH) + 1;// Java月份从0月开始
            @SuppressLint("WrongConstant") int curDay = c.get(Calendar.DAY_OF_MONTH);
    ...
    public static boolean isNight(Weather weather) {
        ...
        try {
            ...
            if (todayForecast != null) {
                ...
                return !(curTime > srTime && curTime <= ssTime);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
