...
import kelijun.com.qbox.model.entities.textjoke.BaseJokeBean;
...
public class TextJokeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    SwipeRefreshLayout mSwiperTextjoke;//下拉刷新
    ...
    private void initRecy() {
        ...
        mRecyTextjoke.addOnItemTouchListener(new OnItemChildLongClickListener() {
            @Override
    ...
    private void initEmptyView() {
        errorView = getActivity().getLayoutInflater()
                .inflate(R.layout.error_view, (ViewGroup) mRecyTextjoke.getParent(), false);
        notDataView = getActivity().getLayoutInflater()
                .inflate(R.layout.empty_view, (ViewGroup) mRecyTextjoke.getParent(), false);
