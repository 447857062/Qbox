package kelijun.com.qbox.module.find.chinacalendar;
...
import kelijun.com.qbox.utils.webviewutils.ObjectSaveManager;
import rx.Observer;
...
public class ChinaCalendarActivity extends BaseCommonActivity {
    ...
    private Observer<ChinaCalendar> mObserver = new Observer<ChinaCalendar>() {
        @Override
