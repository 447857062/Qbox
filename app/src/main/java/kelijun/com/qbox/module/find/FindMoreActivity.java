...
public class FindMoreActivity extends BaseCommonActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void initRecyclerView() {
        mFindMoreAdapter = new FindMoreAdapter(this, functionBeanList);
    ...
    private void addFooterView() {
        View footerView = getLayoutInflater().
                inflate(R.layout.activity_find_more_footer, (ViewGroup) mRecyclerviewFindmore.getParent(), false);
    ...
    private void addHeaderView() {
        View headerView = getLayoutInflater().
                inflate(R.layout.activity_find_more_header, (ViewGroup) mRecyclerviewFindmore.getParent(), false);
        mFindMoreAdapter.addHeaderView(headerView);

    }

    private void initData() {
        mFunctionDao = new FunctionDao(this);
        functionBeanList = mFunctionDao.queryFunctionBeanListSmallNoMore();
    }

    private void initToolbar() {
        setSupportActionBar(mToolbarFindmore);
